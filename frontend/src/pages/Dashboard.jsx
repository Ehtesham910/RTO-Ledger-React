...
function Dashboard() {
  ...
  const requestLabels = stats.chartRequests
    ? stats.chartRequests.map((d) => d.date)
    : [];
  const requestCounts = stats.chartRequests
    ? stats.chartRequests.map((d) => d.count)
    : [];
  ...
  const customerLabels = stats.chartCustomers
    ? stats.chartCustomers.map((d) => d.date)
    : [];
  const customerCounts = stats.chartCustomers
    ? stats.chartCustomers.map((d) => d.count)
    : [];
