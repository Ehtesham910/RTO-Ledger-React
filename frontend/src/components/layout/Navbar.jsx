  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-left">
        <button onClick={toggleSidebar} style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', padding: '0', marginRight: '16px', color: '#6a6e75ff' }}>
